...
| `vcenter_config`           | VMware vCenter configuration                       | <details><summary>object</summary><pre>{<br> resource_pool = optional(string)<br> folder = optional(string)<br>}</pre></details>                                                                                                                                                                                                                                                                                                                         | {}     |
